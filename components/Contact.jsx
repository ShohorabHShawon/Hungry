          ...
          >
            ...
            {contactInfo.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-center justify-center lg:justify-start p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700"
              >
